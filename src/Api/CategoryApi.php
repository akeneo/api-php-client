...
class CategoryApi implements CategoryApiInterface
{
    ...
    {
        return $this->resourceClient->upsertAsyncResource(static::CATEGORY_URI, [$code], $data);
    }
    ...
    {
        return $this->resourceClient->upsertAsyncStreamResourceList(static::CATEGORIES_URI, [], $resources);
    }
}
